...
# REPLACE your threshold_df with this version that has multiple categories per parameter:
...
# EFFICIENCY IMPROVEMENTS - Replace your generate_param_table function:

# EFFICIENCY IMPROVEMENTS - Replace your generate_param_table function:

# EFFICIENCY IMPROVEMENTS - Replace your generate_param_table function:

# REPLACE your entire generate_param_table function with this WORKING version:
...
generate_param_table <- function(df, threshold_df, MonitoringLocationIdentifier) {
  ...
  build_css_bar <- function(low, high, recent_values_str, recent_dates_str, n) {
    ...
    for (i in seq_along(recent_values)) {
      ...
      # FIXED: Simple hover format - value (date)
  ...
  # OPTIMIZED: Process rows with minimal overhead
