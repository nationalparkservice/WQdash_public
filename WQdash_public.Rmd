...
# This forces navset_card_tab to fill height 
tags$style(".tab-content {
...
explore_plots_card <-
  bslib::card(
    ...
    div(style ="flex: 1 1 30%; padding:5px; justify-content:center; align-items:center;",
  ...
  renderUI({
    ...
    renderUI({
      sliderInput("sel_PlotHt",
          ...
          div(style ="flex: 1 1 15%; padding:5px; justify-content:center; align-items:right;",
