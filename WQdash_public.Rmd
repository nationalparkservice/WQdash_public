...
explore_plots_card <-
  bslib::card(
    ...
    div(style ="flex: 1 1 35%; padding:5px; justify-content:center; align-items:left;",
    ...
    div(style ="flex: 1 1 30%; padding:5px; justify-content:center; align-items:left;",
  ...
  actionButton(inputId = "button_plotTable", label = "View Table", icon = icon("table-cells", lib = "font-awesome"), style="color:black; font-size:8pt; background-color: lightblue; display:inline-block; border:1px; margin:1px")
  )
), # end of overall div
