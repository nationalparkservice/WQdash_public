...
showModal(modalDialog(
  ...
  HTML(paste0("<strong>You have summarized ", sum(rv$selectedDataSummary$ResultCount), " data records from ", length(unique(rv$selectedDataSummary$MonitoringLocationIdentifier)), " sites.</strong> Selected monitoring sites are shown as larger, white-outlined circles on the map.", 
              ...
              "<br><br>Review your selection in the 'Summary of Selected Characteristics' and 'Summary of Selected Site-Characteristics' tabs. <br><br>Select gage stations (if available), then press the <strong>DOWNLOAD DATA</strong> button to import the water quality data."))
...
observeEvent(eventExpr = input$button_downloadData, { 
  ...
  shiny::req(length(input$sel_CharType) > 0)
    ...
    showModal(modalDialog(
      ...
      "Please select monitoring sites from which you would like to import data (filter sites by HUC or by distance from origin, then click 'Summarize Selected Sites' button)."
    ))
    }
...
shinyjs::hidden( # initially hide this well panel
  wellPanel(
    id = "new_data_P1",
    p(strong("2 (of 3). Filter sites to download, then click 'SUMMARIZE SELECTED SITES' button")),
...
conditionalPanel(
  ...
  div(style = "margin-top: -8px; margin-bottom: 5px;",
    ...
    actionButton("button_summarizeStations", "SUMMARIZE SELECTED SITES", width = "100%", style="color:black; background-color: lightgreen; border: 1px solid black; display:inline-block; margin:5px")
