...
#> fix data imports so they don't ping API twice
...
showModal(modalDialog(
  ...
  HTML(paste0("<strong>You have selected ", sum(rv$selectedDataSummary$ResultCount), " data records from ", length(unique(rv$selectedDataSummary$MonitoringLocationIdentifier)), " sites.</strong> Review your selection in the 'Summary of Selected Data' and 'Summary of Selected Characteristics' tabs. <br><br>Selected monitoring sites are shown as larger, white-outlined circles on the map.", 
              ...
              "<br><br>Select gage stations (if available), then press the <strong>DOWNLOAD SELECTED DATA</strong> button to import the water quality data."))
...
* <font size="0.75"> The filtered data shown here will be used on the Explore Data page.</font>
...
* <font size="0.75"> The 'Sample Size Matrix' tab shows the number of samples collected per season (or month) each year, for the selected water quality characteristic.</font>
