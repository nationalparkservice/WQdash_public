...
# A large update of dataRetrieval was just pushed to GitHub. This update will allow users to access the new "WQX3" profiles from the Water Quality Portal. Any new USGS discrete water quality data since March 11th is ONLY availablerv via dataRetrieval from these new data profiles. With this update, all WQP functions that can use these new profiles will use them by default.
#  
