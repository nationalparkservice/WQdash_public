...
for(i in 1:length(rv$wqp_url_list)) {
  ...
  all_data[[i]] <- readr::read_csv(tmpDat, show_col_types = FALSE) %>%
  ...
  this.on('contextmenu', function(e) {
    ...
    if (this._layers) {
      Object.values(this._layers).forEach(function(layer) {
        if (layer.options && 
            (layer.options.group === 'Imported monitoring sites' || 
