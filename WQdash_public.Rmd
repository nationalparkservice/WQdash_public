...
### NEXT CHANGES:
# > Import
# -- Switch to dataRetrieval
# -- Prior to import, show number of sites and data records
...
observeEvent(eventExpr = input$button_highlightStations, {
  ...
  if(input$sel_SelectMethod == "methodHuc") {
    ...
    # Get statistics about the parameters and number of data records for the selected sites
...
observeEvent(eventExpr = input$button_downloadData, { 
  ...
  summaryURL <- paste0("https://www.waterqualitydata.us/data/summary/monitoringLocation/", searchURL)
  
  datURL <- paste0("https://www.waterqualitydata.us/data/Result/", searchURL)
  # <<<<<< PICK UP FROM HERE
  rv$wqp_url <- datURL
