...
### Add streamflow/precip ----
#     shinyWidgets::dropdownButton(
#     inputId = "plot_additional_data",
#     label = "Streamflow/precipitation",
#     circle = FALSE,
#     status = "button_menu_add_to_plots",
#     icon = icon("cloud-showers-water"),
#     tooltip = "Add imported streamflow and/or precipitation data to plots",
...
### Plot format options ----
    #   shinyWidgets::dropdownButton(
    # inputId = "plot_display_options",
    # label = "Display Options",
    # circle = FALSE,
    # status = "button_menu_format_plots",
    # icon = icon("chart-line"),
    # tooltip = "Modify plot type, axes, etc.",
