...
# renderUI({
#   shiny::req(!is.null(input$sel_ParamMapShow), !is.null(input$sel_SummarizeBy), !is.null(rv_param_temp$param_map_highlight), !is.null(isolate(rv_param_temp$update_from_sidebar)))
#   shiny::req(input$sel_ParamMapShow == "show", isolate(rv_param_temp$update_from_sidebar) == TRUE) # when param_map marker set to "show"
#     cat("UPDATE FROM SIDEBAR\n")  
#   #   
#   #           saveRDS(isolate(reactiveValuesToList(rv)), here::here("TEMP_rv.RDS"))
#   # saveRDS(isolate(reactiveValuesToList(rv_param_temp)), here::here("TEMP_rv_param_temp.RDS"))
#   # saveRDS(isolate(reactiveValuesToList(input)), here::here("TEMP_input.RDS"))
